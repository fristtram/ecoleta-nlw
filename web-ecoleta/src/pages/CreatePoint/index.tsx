...
// Sempre que criamos Array ou objeto manualmente, precisamos informar o tipo da variavel
interface Item {
    id: number;
    title: string;
    image_url: string;
...
const CreatePoint = () => {
    ...
    // Primero parametro, qual função quero executar, segundo parametro, quando quero executar
    // useEffect(() => {}, []);
    useEffect(() => {
    ...
    function handleInputChange(event: ChangeEvent<HTMLInputElement>) {
        ...
        // Para manter os dados que já tem, vamos usar spread operator (...)
        setFormData({ ...formData, [name]: value})
    }

    function handleSelectItem(id: number) {
        // Verificar se já selecionei o mesmo item
        ...
        if (alreadySelected >= 0) {
            ...
            // Selecionar um novo, mas agrupando os já selecionado
